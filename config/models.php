    ...
    '*' => [
        ...
        */
        ...
        /*
         ...
         |
         | ...
         | $builder->select([Usuario::USER_NAME])->where(Usuario::AGE, '<=', 18);
         | ...
         |
